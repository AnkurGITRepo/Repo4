...
<html>
<body>
	<h2 align="left">All Employee List</h2>
<html>
<body>
	${"deleteMessage"}

	<table table id="tablepaging" class="yui" align="center">
		<tr>
			<th>Sr.No</th>
			<th>Name</th>
			<th>Designation</th>
		...
		<c:forEach var="employee" items="${list}">
			<tr>
				...
				<td><a href="editEmployee?id=${employee.eNo}">Edit</a> <a
					href="deleteEmployee?id=${employee.eNo}">delete</a></td>
			</tr>
		</c:forEach>
	</table>
</body>
